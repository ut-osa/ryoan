...
#define tcon_container_type(x, canary) tcon_type(x, _container_##canary)
#define tcon_container_ptr_type(x, canary) tcon_ptr_type(x, _container_##canary)
#define tcon_container_sizeof(x, canary) tcon_sizeof(x, _container_##canary)
 ...
 * canary.
 */
#define tcon_member_check(x, canary, expr) tcon_check(x, _member_##canary, expr)
#define tcon_member_check_ptr(x, canary, expr) \
  tcon_check_ptr(x, _member_##canary, expr)
#define tcon_member_type(x, canary) tcon_type(x, _member_##canary)
#define tcon_member_ptr_type(x, canary) tcon_ptr_type(x, _member_##canary)
#define tcon_member_sizeof(x, canary) tcon_sizeof(x, _member_##canary)
#define tcon_member_cast(x, canary, expr) tcon_cast(x, _member_##canary, expr)
 ...
 * @canary: which container canary to check against.
 */
#define tcon_offset(x, canary) tcon_value((x), _offset_##canary)
...
#define tcon_container_of(x, canary, member_ptr)                \
  tcon_container_cast_ptr(                                      \
      tcon_member_check_ptr((x), canary, (member_ptr)), canary, \
      tcon_container_of_((member_ptr), tcon_offset((x), canary)))
...
#define tcon_member_of(x, canary, container_ptr)                      \
  tcon_member_cast_ptr(                                               \
      tcon_container_check_ptr((x), canary, (container_ptr)), canary, \
      tcon_member_of_((container_ptr), tcon_offset((x), canary)))
