 ...
 */
unsigned char *get_result(cert_ctx ctx, ssize_t *len);
int get_result_desc(cert_ctx ctx, char **desc, ssize_t *dlen,
 ...
 */
int list_ops(cert_ctx ctx, SGX_identity_t *op_list, size_t nops);
