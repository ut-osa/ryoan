...
#include "native_client/src/untrusted/nacl/ryoan_ops.h"
...
int wait_for_request(bool output_app_label) {
  return errno_call(NACL_GC_WRAP_SYSCALL(NACL_SYSCALL(wait_for_request)(output_app_label)));
}

int ryoan_trusted_op(int op, void *arg1, void *arg2, void *arg3, void *arg4) {
  return errno_call(NACL_SYSCALL(trusted_exec)(op, arg1, arg2, arg3, arg4));
}
